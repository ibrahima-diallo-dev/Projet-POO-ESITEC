...
--
-- Hôte : localhost:3306
-- Généré le : mer. 04 mars 2026 à 23:53
...
INSERT INTO `classes` (`id_classe`, `nom_classe`, `filiere`, `id_responsable`) VALUES
(1, 'L1 Informatique A', 'Informatique', 19),
(2, 'L2 Informatique B', 'Informatique', 20),
(3, 'L3 Informatique', 'Informatique', 21),
(4, 'L1 Gestion A', 'Gestion', 22),
...
INSERT INTO `cours` (`id_cours`, `intitule`, `volume_horaire`, `id_enseignant`, `id_classe`) VALUES
...
INSERT INTO `seances` (`id_seance`, `date_seance`, `heure_debut`, `duree`, `contenu`, `observations`, `statut`, `commentaire_rejet`, `id_cours`, `id_enseignant`) VALUES
...
INSERT INTO `utilisateurs` (`id_user`, `nom_user`, `prenom_user`, `email`, `mot_de_passe`, `role`, `statut`, `date_creation`, `date_inscription`) VALUES
(2, 'nom_user', 'prenom_user', 'email', 'mot_de_passe', '', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
...
(6, 'FALL', 'Cheikh', 'cheikh.fall@esitec.sn', 'prof123', 'ENSEIGNANT', 'VALIDE', '2025-09-01 08:00:00', '2025-09-15 10:00:00'),
...
(19, 'NGOM', 'Binta', 'binta.ngom@esitec.sn', 'prof123', 'ENSEIGNANT', 'VALIDE', '2025-09-01 08:00:00', '2025-09-15 10:00:00'),
(20, 'KANE', 'Lamine', 'lamine.kane@esitec.sn', 'prof123', 'ENSEIGNANT', 'VALIDE', '2025-09-01 08:00:00', '2025-09-15 10:00:00'),
(21, 'LO', 'Sokhna', 'sokhna.lo@esitec.sn', 'resp123', 'RESPONSABLE_CLASSE', 'VALIDE', '2025-09-01 08:00:00', '2025-09-15 10:00:00'),
(22, 'NIANG', 'Babacar', 'babacar.niang@esitec.sn', 'resp123', 'RESPONSABLE_CLASSE', 'VALIDE', '2025-09-01 08:00:00', '2025-09-15 10:00:00'),
...
--
ALTER TABLE `cours`
  MODIFY `id_cours` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT pour la table `seances`
--
ALTER TABLE `seances`
  MODIFY `id_seance` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;
...
--
ALTER TABLE `classes`
  ADD CONSTRAINT `classes_ibfk_1` FOREIGN KEY (`id_responsable`) REFERENCES `utilisateurs` (`id_user`) ON DELETE SET NULL;

--
-- Contraintes pour la table `cours`
--
ALTER TABLE `cours`
  ADD CONSTRAINT `cours_ibfk_1` FOREIGN KEY (`id_enseignant`) REFERENCES `utilisateurs` (`id_user`) ON DELETE SET NULL,
  ADD CONSTRAINT `cours_ibfk_2` FOREIGN KEY (`id_classe`) REFERENCES `classes` (`id_classe`) ON DELETE SET NULL;

--
-- Contraintes pour la table `seances`
--
ALTER TABLE `seances`
  ADD CONSTRAINT `seances_ibfk_1` FOREIGN KEY (`id_cours`) REFERENCES `cours` (`id_cours`) ON DELETE SET NULL,
  ADD CONSTRAINT `seances_ibfk_2` FOREIGN KEY (`id_enseignant`) REFERENCES `utilisateurs` (`id_user`) ON DELETE SET NULL;
COMMIT;
